...
const FEATURES = [
    ...
    { featureKey: 'FEATURE:ADMIN_OTS_CLEANUP',    module: 'ADMIN',            submodule: 'OTS_CLEANUP',  description: 'Expired One-Time Secrets cleanup' },
...
const ROLES_MATRIX: {
    ...
    },
    {
        ...
        permissions: {
            ...
            'FEATURE:ADMIN_OTS_CLEANUP':   'NO_ACCESS',
