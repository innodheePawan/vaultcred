...
import { AlertCircle, Loader2, ArrowLeft, ShieldCheck, Mail, CheckCircle, Eye, EyeOff } from 'lucide-react';
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                className="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:text-white dark:ring-gray-700 disabled:opacity-50"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2 relative">
                            <input
                                ...
                                className="block w-full rounded-md border-0 pl-3 pr-10 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:text-white dark:ring-gray-700 disabled:opacity-50"
                            />
                            <button
                                type="button"
