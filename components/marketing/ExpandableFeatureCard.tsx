...
export function ExpandableFeatureCard({ title, items, defaultOpen = false }: ExpandableFeatureCardProps) {
    ...
    return (
        <div className="border border-white/[0.06] rounded-lg bg-white/[0.02] overflow-hidden transition-colors hover:border-white/[0.1]">
            <button
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-mono text-slate-500 bg-white/[0.04] px-2 py-0.5 rounded-full">
                        {items.length}
                    </span>
                </div>
                <ChevronDown
