        ...
        >
            <section className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.06] text-xs font-mono space-y-1">
                    <p className="font-semibold text-slate-900 dark:text-white">Security Contact Email: <a href="mailto:customer-support@getcredsecure.com" className="text-blue-600 dark:text-blue-400 underline break-words">customer-support@<wbr />getcredsecure.com</a></p>
