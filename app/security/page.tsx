...
import { SecurityLayersVisual } from "@/components/marketing/SecurityLayersVisual";
    ...
    return (
        <div className="relative min-h-screen bg-slate-50 dark:bg-[#030712] text-slate-900 dark:text-slate-50 font-sans">
            ...
            <main className="relative z-10 pt-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-5 text-left">
                            ...
                            <h1 className="text-2xl sm:text-3xl lg:text-[2.65rem] font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.25] max-w-2xl">
                                <div>Your Credentials Are Sensitive.</div>
                                <div className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-cyan-500 dark:from-indigo-400 dark:via-purple-400 dark:to-cyan-400 mt-1">
                                    CredSecure Is Built to Protect Them.
                                </div>
                            </h1>

                            <p className="text-base sm:text-lg text-slate-650 dark:text-slate-300 leading-relaxed max-w-xl">
                                CredSecure protects credentials through encryption, controlled access, strong authentication, threat protection and complete audit traceability — across both user and application access.
                            </p>

                            {/* CTA Actions */}
                            <div className="flex flex-wrap items-center gap-4 pt-2">
                                <a href="#security-layers">
                        ...
                        {/* Right Column: Concentric Security Protection Layers Visual */}
                ...
                {/* Security at a Glance Streamlined Cards Section */}
                <section className="border-y border-slate-200 dark:border-white/[0.06] bg-slate-100/60 dark:bg-[#090d16]/50 py-6">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                            {[
                                { title: "Encryption", desc: "Credentials encrypted at rest", icon: LockKeyhole, color: "text-blue-500" },
                                { title: "Access Control", desc: "Least-privilege access", icon: ShieldCheck, color: "text-indigo-500" },
                                { title: "Strong Authentication", desc: "MFA-protected user access", icon: Fingerprint, color: "text-purple-500" },
                                { title: "Threat Protection", desc: "Abuse & access protection", icon: AlertTriangle, color: "text-amber-500" },
                                { title: "Audit & Traceability", desc: "Security actions recorded", icon: FileCheck, color: "text-emerald-500" },
                            ].map((pillar, idx) => {
                                const IconComponent = pillar.icon;
                                return (
                                    <div key={idx} className="p-3.5 sm:p-4 rounded-xl border border-slate-200/90 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] shadow-2xs hover:border-slate-300 dark:hover:border-white/10 transition-colors flex flex-col justify-between space-y-2">
                                        <div className="flex items-center gap-2">
                                            <IconComponent className={`w-4 h-4 ${pillar.color}`} strokeWidth={2} />
                                            <span className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white font-sans">{pillar.title}</span>
                                        </div>
                                        <span className="text-xs text-slate-600 dark:text-slate-400 font-sans leading-snug">{pillar.desc}</span>
                                    </div>
                                );
                            })}
                        </div>
                ...
                {/* Detailed Security Architecture Section Container */}
                <div id="security-layers" className="scroll-mt-20">
                            ...
                            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                {[
                                    { 
                                        ...
                                        meta: "OAUTH 2.0 CLIENT CREDS • SCOPED MACH TOKENS"
                                    },
                                    { 
